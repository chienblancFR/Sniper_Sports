...
NAME_MAPPING = {
    ...
    # ============================================================
    # 🇫🇷 LIGUE 2 — compléments (L1 déjà mappé)
    # ============================================================
    "FC Metz":                  "Metz",
    "Metz":                     "Metz",
    "SM Caen":                  "Caen",
...
CHAMPIONNATS = [
    ...
    {"nom": "🇦🇹 Bundesliga AT", "id": 218, "key": "soccer_austria_bundesliga", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 4, "rel": 11},
    {"nom": "🇩🇰 Superliga", "id": 119, "key": "soccer_denmark_superliga", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 4, "rel": 11},
    {"nom": "🏴󠁧󠁢󠁳󠁣󠁴󠁿 Premiership", "id": 179, "key": "soccer_spl", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 4, "rel": 11},
    {"nom": "🇵🇱 Ekstraklasa", "id": 106, "key": "soccer_poland_ekstraklasa", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 4, "rel": 16},
    {"nom": "🇫🇷 Ligue 2", "id": 62, "key": "soccer_france_ligue_two", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 3, "rel": 17},
    {"nom": "🇩🇪 Bundesliga 2", "id": 79, "key": "soccer_germany_bundesliga2", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 3, "rel": 16},
    {"nom": "🇸🇦 Pro League", "id": 307, "key": "soccer_saudi_arabia_pro_league", "ev_min": 0.05, "ev_max": 0.15, "c1": 2, "euro": 4, "rel": 16},
]
...
async def actualiser_stats_ligue(session, ligue_cfg, season):
    ...
    is_euro = not any(
        ...
        for mot in [
            "Brésil", "Allsvenskan", "MLS", "Eliteserien",
            "Super League", "Bundesliga AT", "Superliga", "Ekstraklasa",
        ]
    )

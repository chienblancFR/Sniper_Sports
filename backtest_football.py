...
CHAMPIONNATS = [
    ...
    {"nom": "Bundesliga AT",     "id": 218, "key": "soccer_austria_bundesliga",        "c1": 2,  "euro": 4,  "rel": 11, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Superliga",        "id": 119, "key": "soccer_denmark_superliga",         "c1": 2,  "euro": 4,  "rel": 11, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Premiership",      "id": 179, "key": "soccer_spl",                       "c1": 2,  "euro": 4,  "rel": 11, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Ekstraklasa",      "id": 106, "key": "soccer_poland_ekstraklasa",        "c1": 2,  "euro": 4,  "rel": 16, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Ligue 2",          "id": 62,  "key": "soccer_france_ligue_two",          "c1": 2,  "euro": 3,  "rel": 17, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Bundesliga 2",     "id": 79,  "key": "soccer_germany_bundesliga2",       "c1": 2,  "euro": 3,  "rel": 16, "ev_min": 0.05, "ev_max": 0.15},
    {"nom": "Pro League",       "id": 307, "key": "soccer_saudi_arabia_pro_league",   "c1": 2,  "euro": 4,  "rel": 16, "ev_min": 0.05, "ev_max": 0.15},
]
...
NAME_MAPPING = {
    ...
    "FK Austria Wien": "Austria Vienna", "Austria Wien": "Austria Vienna", "Austria Vienna": "Austria Vienna",
    "SK Rapid Wien": "Rapid Vienna", "Rapid Wien": "Rapid Vienna", "Rapid Vienna": "Rapid Vienna",
    "LASK Linz": "Lask Linz", "LASK": "Lask Linz",
    "Wolfsberger AC": "Wolfsberger AC",
    "WSG Tirol": "WSG Wattens", "WSG Swarovski Tirol": "WSG Wattens",
    "SCR Altach": "SCR Altach", "TSV Hartberg": "Hartberg",
    "Grazer AK": "Grazer AK", "Blau-Weiß Linz": "BW Linz", "FC BW Linz": "BW Linz",
    # 🇩🇰 SUPERLIGA
    "FC København": "FC Copenhagen", "FC Copenhagen": "FC Copenhagen", "København": "FC Copenhagen",
    "FC Midtjylland": "Midtjylland", "Midtjylland": "Midtjylland",
    "Brøndby IF": "Brondby", "Brondby": "Brondby",
    "AGF Aarhus": "Aarhus", "Aarhus GF": "Aarhus", "Aarhus": "Aarhus",
    "Silkeborg IF": "Silkeborg", "Silkeborg": "Silkeborg",
    "Viborg FF": "Viborg", "Viborg": "Viborg",
    "Randers FC": "Randers FC", "Randers": "Randers FC",
    "Nordsjælland": "FC Nordsjaelland", "FC Nordsjælland": "FC Nordsjaelland", "FC Nordsjaelland": "FC Nordsjaelland",
    "Aalborg BK": "Aalborg", "AaB": "Aalborg",
    "Lyngby BK": "Lyngby", "Lyngby": "Lyngby",
    "SønderjyskE": "Sonderjyske", "Sonderjyske": "Sonderjyske",
    "Vejle BK": "Vejle", "Vejle": "Vejle",
    # 🏴󠁧󠁢󠁳󠁣󠁴󠁿 PREMIERSHIP
    "Celtic FC": "Celtic", "Celtic": "Celtic",
    "Rangers FC": "Rangers", "Rangers": "Rangers",
    "Aberdeen FC": "Aberdeen", "Aberdeen": "Aberdeen",
    "Heart of Midlothian": "Hearts", "Hearts": "Hearts",
    "Hibernian FC": "Hibernian", "Hibernian": "Hibernian",
    "Motherwell FC": "Motherwell", "Motherwell": "Motherwell",
    "Kilmarnock FC": "Kilmarnock", "Kilmarnock": "Kilmarnock",
    "St. Mirren": "St Mirren", "St Mirren": "St Mirren",
    "Dundee United": "Dundee Utd", "Dundee Utd": "Dundee Utd",
    "Dundee FC": "Dundee", "Dundee": "Dundee",
    "Ross County FC": "Ross County", "Ross County": "Ross County",
    "St. Johnstone FC": "St Johnstone", "St Johnstone": "St Johnstone",
    "Livingston FC": "Livingston", "Livingston": "Livingston",
    # 🇵🇱 EKSTRAKLASA
    "Legia Warszawa": "Legia Warsaw", "Legia Warsaw": "Legia Warsaw",
    "Lech Poznań": "Lech Poznan", "Lech Poznan": "Lech Poznan",
    "Jagiellonia Białystok": "Jagiellonia", "Jagiellonia": "Jagiellonia",
    "Raków Częstochowa": "Raków Częstochowa", "Rakow Czestochowa": "Raków Częstochowa",
    "Pogoń Szczecin": "Pogon Szczecin", "Pogon Szczecin": "Pogon Szczecin",
    "Śląsk Wrocław": "Slask Wroclaw", "Slask Wroclaw": "Slask Wroclaw",
    "Górnik Zabrze": "Gornik Zabrze", "Gornik Zabrze": "Gornik Zabrze",
    "Cracovia Kraków": "Cracovia", "Cracovia": "Cracovia",
    "Wisła Kraków": "Wisla Krakow", "Wisla Krakow": "Wisla Krakow",
    "Zagłębie Lubin": "Zaglebie Lubin", "Zaglebie Lubin": "Zaglebie Lubin",
    "Piast Gliwice": "Piast Gliwice",
    "Widzew Łódź": "Widzew Lodz", "Widzew Lodz": "Widzew Lodz",
    "Korona Kielce": "Korona Kielce", "Stal Mielec": "Stal Mielec",
    "Puszcza Niepołomice": "Puszcza Niepolomice",
    "Lechia Gdańsk": "Lechia Gdansk", "Lechia Gdansk": "Lechia Gdansk",
    "Motor Lublin": "Motor Lublin",
    # 🇫🇷 LIGUE 2
    "FC Metz": "Metz", "Metz": "Metz", "SM Caen": "Caen", "Caen": "Caen",
    "Grenoble Foot 38": "Grenoble", "Grenoble": "Grenoble",
    "Amiens SC": "Amiens", "Amiens": "Amiens", "Pau FC": "Pau", "Pau": "Pau",
    "USL Dunkerque": "Dunkerque", "Dunkerque": "Dunkerque",
    "ESTAC Troyes": "Troyes", "Troyes": "Troyes", "Rodez AF": "Rodez", "Rodez": "Rodez",
    "FC Annecy": "Annecy", "Annecy": "Annecy", "SC Bastia": "Bastia", "Bastia": "Bastia",
    "Paris FC": "Paris FC", "EA Guingamp": "Guingamp", "Guingamp": "Guingamp",
    "Stade Lavallois": "Laval", "Laval": "Laval",
    "Red Star FC": "Red Star", "Red Star": "Red Star",
    "Clermont Foot 63": "Clermont", "Clermont": "Clermont",
    # 🇩🇪 BUNDESLIGA 2
    ...
    "Hannover 96": "Hannover 96", "Holstein Kiel": "Holstein Kiel",
    "SV Darmstadt 98": "Darmstadt", "Darmstadt": "Darmstadt",
    "Karlsruher SC": "Karlsruher SC",
    "1. FC Magdeburg": "Magdeburg", "Magdeburg": "Magdeburg",
    "FC St. Pauli": "St Pauli", "St. Pauli": "St Pauli", "St Pauli": "St Pauli",
    "SpVgg Greuther Fürth": "Greuther Furth", "Greuther Furth": "Greuther Furth",
    "Eintracht Braunschweig": "Braunschweig",
    "SC Paderborn 07": "Paderborn", "Paderborn": "Paderborn",
    "1. FC Nürnberg": "Nurnberg", "Nurnberg": "Nurnberg",
    "SSV Ulm 1846": "Ulm", "Ulm": "Ulm",
    "Preußen Münster": "Preussen Munster", "Preussen Munster": "Preussen Munster",
    "SV Elversberg": "Elversberg", "Elversberg": "Elversberg",
    "FC Cologne": "FC Koeln",
    # 🇸🇦 PRO LEAGUE
    "Al-Hilal Saudi FC": "Al Hilal", "Al Hilal": "Al Hilal",
    "Al-Nassr": "Al Nassr", "Al Nassr": "Al Nassr",
    "Al-Ittihad FC": "Al Ittihad", "Al Ittihad": "Al Ittihad",
    "Al-Ahli Saudi FC": "Al Ahli", "Al Ahli": "Al Ahli",
    "Al-Ettifaq FC": "Al Ettifaq", "Al Ettifaq": "Al Ettifaq",
    "Al-Shabab": "Al Shabab", "Al Shabab": "Al Shabab",
    "Al-Fateh SC": "Al Fateh", "Al Fateh": "Al Fateh",
    "Al-Taawoun FC": "Al Taawon", "Al Taawon": "Al Taawon",
    "Al-Raed FC": "Al Raed", "Al Raed": "Al Raed",
    "Damac FC": "Damac", "Damac": "Damac",
    "Al-Fayha FC": "Al Feiha", "Al Feiha": "Al Feiha",
    "Al-Khaleej Saihat": "Al Khaleej", "Al Khaleej": "Al Khaleej",
    "Al-Okhdood Club": "Al Okhdood", "Al Okhdood": "Al Okhdood",
    "Al-Riyadh SC": "Al Riyadh", "Al Riyadh": "Al Riyadh",
    "Al-Kholood": "Al Kholood", "Al Kholood": "Al Kholood",
    "Al-Qadsiah FC": "Al Qadsiah", "Al Qadsiah": "Al Qadsiah",
    "Al-Wehda FC": "Al Wehda", "Al Wehda": "Al Wehda",
